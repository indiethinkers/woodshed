...
possible violation, email **daniel@indiethinkers.com** with the subject
"Woodshed Code of Conduct." If the report concerns that moderator, say so in
the message; it will not be handled solely by the person named in the report.
Do not open a public issue for a report that contains sensitive information.
...
3. **Temporary Suspension**
   ...
   - **Repair:** Examples include respecting the spirit of the suspension,
     meeting the conditions for return, and reintegrating thoughtfully.
4. **Permanent Ban**
   - **Event:** A pattern of repeated violations that other steps have failed
     to resolve, or a violation so serious that Community Moderators determine
   ...
   - **Consequence:** Access to all community spaces, tools, and communication
     channels is removed. Permanent bans should be rare, strongly reasoned, and
     used only when other remedies cannot protect the community.
   - **Repair:** There is no possible repair in cases of this severity.

This enforcement ladder is a guideline. It does not limit Community Moderators'
discretion and judgment when acting in the community's best interests.
