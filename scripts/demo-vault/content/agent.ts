...
const CHATS: ChatSeed[] = [
  {
    id: "chat-spc-application",
    title: "Draft the SPC application answer",
    offset: -7,
    pinned: true,
    tags: ["fundraise"],
    context: {
      title: "South Park Commons — what to lead with",
      route: "/notebook/spc-application-notes",
    },
    turns: [
      {
        role: "user",
        time: "08:35",
        content: [
          "I'm applying to South Park Commons. I have my YC draft open. Should I",
          "reuse those answers?",
        ].join("\n"),
      },
      {
        ...
        content: [
          ...
          "",
          "Your YC draft leads with traction — WAU, retention, MRR, design partners.",
          "That's the right shape for an accelerator optimising for whether this gets",
          "big.",
          "",
          "But your note [[South Park Commons — what to lead with]] already makes the",
          "case that SPC is asking a different question: is the problem genuinely",
          ...
          "",
          "> The Markdown files are canonical. Everything else — index, caches, link",
          "> graph — is derived and disposable. Here's what that rules out, here's what",
      ...
      },
      {
        ...
        content: [
          ...
          "   is Priya saying she goes looking for the paragraph where you admit what",
    ...
    turns: [
      ...
      },
      {
        ...
        content: [
          ...
          "**Moving**",
          "",
          "- **Northwind** — diligence, $1.5M. Partner meeting Thursday is the",
          "  decision. [[Priya Raman]] has asked twice for the retention cut by",
          ...
          "to Priya, and the fill-or-co-lead answer to Daniel.",
        ].join("\n"),
      },
      {
        role: "user",
      ...
      },
      {
        ...
        content: [
          ...
          "",
          "**In diligence:** $2.5M across Northwind and Foundry Line. Both are",
          "realistically decision-stage rather than speculative.",
          "",
          "**Speculative:** $900k across Brightwater and Kestrel.",
          "",
          "Worth noting the arithmetic: Northwind and Foundry Line together are $2.5M,",
    ...
    turns: [
      ...
      },
      {
        ...
        content: [
          ...
          "",
          "**[[Ravi Menon]]** (Cartogram) — runs a laptop and a desktop through iCloud.",
